...
public class  AStarExp_917272594 implements AIModule
{
    ...
    //Heuristic for Exp cost is simply Euclidean distance divded by 200 to scale the heuristic to allow for less skew
    private double getHeuristic(Point p1, Point p2){
        return (Math.sqrt(((p2.x - p1.x) * (p2.x - p1.x)) + ((p2.y - p1.y) * (p2.y - p1.y))))/200;        
        //return 0.0;
